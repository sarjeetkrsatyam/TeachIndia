...
import profile from '../Data/images/profile5.jpeg';
    ...
    <View>
      <View style={styles.asteachermain}>
        ...
        <View>
          ...
          />
          <TextInput
            placeholder="Which class you are looking:-"
            style={styles.nametext}
          />
          <TextInput
            placeholder="Which subject you are looking:-"
            style={styles.nametext}
          />
          <TextInput
            placeholder="Any specific Timing:-"
            style={styles.nametext}
          />
          <TextInput
